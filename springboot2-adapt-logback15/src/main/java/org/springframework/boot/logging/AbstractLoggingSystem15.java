...
public abstract class AbstractLoggingSystem15 extends LoggingSystem {
    ...
    public AbstractLoggingSystem15(ClassLoader classLoader) {
    ...
    protected final void applySystemProperties(Environment environment, LogFile logFile) {
        new LoggingSystem15Properties(environment, getDefaultValueResolver(environment), null).apply(logFile);
    }
    ...
    protected Function<String, String> getDefaultValueResolver(Environment environment) {
        ...
        return (name) -> {
            if (StringUtils.hasLength(defaultLogCorrelationPattern)
                    ...
                    && environment.getProperty(LoggingSystem15.EXPECT_CORRELATION_ID_PROPERTY, Boolean.class, false)) {
