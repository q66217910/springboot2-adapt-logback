...
import org.springframework.boot.logging.LoggingSystem15Properties;
 ...
 */
public class LogbackLoggingSystem15Properties extends LoggingSystem15Properties {
    ...
    public LogbackLoggingSystem15Properties(Environment environment) {
        super(environment);
    }
     ...
     * @since 2.4.3
     */
    public LogbackLoggingSystem15Properties(Environment environment, BiConsumer<String, String> setter) {
