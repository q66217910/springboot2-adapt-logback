 ...
 */
public class LoggingSystem15Properties {
     ...
     */
    public LoggingSystem15Properties(Environment environment) {
     ...
     * @since 2.4.2
     */
    public LoggingSystem15Properties(Environment environment, BiConsumer<String, String> setter) {
     ...
     * @since 3.2.0
     */
    public LoggingSystem15Properties(Environment environment, Function<String, String> defaultValueResolver,
